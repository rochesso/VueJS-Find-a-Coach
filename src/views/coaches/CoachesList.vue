    ...
    <section>
      <BaseCard>
        <div class="controls">
          ...
          <BaseButton v-if="!isLoggedIn" link :to="{ name: 'auth', query: { redirect: 'register' } }">Login to register as
            a Coach</BaseButton>
          <BaseButton v-if="!isCoach && !isLoading && isLoggedIn" link :to="{ name: 'register' }">Register as a Coach
          </BaseButton>
        </div>
        <div v-if="isLoading">
